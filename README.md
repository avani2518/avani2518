...
🌱 Exploring Cloud Computing, System Design, Microservices, and AI-powered Applications

🏆 Smart India Hackathon 2025 Qualifier | HackMITWPU'25 Ideathon Semi-Finalist

💡 I enjoy building impactful solutions that combine AI with real-world applications in healthcare, governance, and e-commerce.
...
Developed machine learning models to predict maternal, fetal, and heart disease risks with up to 95% accuracy using Random Forest, XGBoost, Logistic Regression, and AdaBoost.

### 🛒 Indian Handicrafts E-Commerce Platform

Built a full-stack MERN application featuring authentication, product management, and secure payment integration.

### 🤖 VANI – AI-Powered e-Governance Kiosk

Created a multilingual AI assistant integrating OCR, NLP, voice interaction, and LLM-powered form assistance.

### 📄 Resume Builder & Analyzer

Developed an NLP-powered application that analyzes resumes, matches job descriptions, and generates AI-driven recommendations.
